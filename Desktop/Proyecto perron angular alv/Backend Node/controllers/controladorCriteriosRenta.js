...
exports.createCriterio = (req, res) => {
    const { descripcion, min_valoraciones, max_incidencias, aplicable_a_tipo_renta } = req.body;
    ...
    const newCriterio = {
        ...
        min_valoraciones,
        max_incidencias,
        aplicable_a_tipo_renta: aplicable_a_tipo_renta || null // Asignar null si no se proporciona
    };
